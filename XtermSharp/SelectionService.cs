...
namespace XtermSharp
{
    ...
    {
        private readonly PointComparer comparer;
        private readonly Terminal terminal;
        private readonly NStack.ustring nullString;
        private readonly NStack.ustring spaceString;
        private bool active;
        ...
        private Line[] GetSelectedLines(Point start, Point end)
        {
        ...
        private string TranslateBufferLineToString(Buffer buffer, int line, int start, int end)
        {
        ...
        /// </summary>
        private void SimpleScanSelection(int col, int row, Func<CharData, bool> includeFunc)
        {
            var buffer = terminal.Buffer;
        ...
        /// </summary>
        private void BalancedSearchForward(int col, int row)
        {
            var buffer = terminal.Buffer;
            var startCol = col;
        ...
        /// made of pairs of parenthesis, braces and brackets.
        /// </summary>
        private void BalancedSearchBackward(int col, int row)
        {
            var buffer = terminal.Buffer;
            var startCol = col;
            var wait = new List<CharData>();
