...
public class RuneExt
{
    ...
    private const byte xx = 0xF1; // invalid: size 1
    private const byte a1 = 0xF0; // a1CII: size 1
    private const byte s1 = 0x02; // accept 0, size 2
    private const byte s2 = 0x13; // accept 1, size 3
    private const byte s3 = 0x03; // accept 0, size 3
    private const byte s4 = 0x23; // accept 2, size 3
    private const byte s5 = 0x34; // accept 3, size 4
    private const byte s6 = 0x04; // accept 0, size 4
    private const byte s7 = 0x44; // accept 4, size 4

    private static byte[] first = new byte[256]{
    ...
    private const byte locb = 0x80; // 1000 0000

    private const byte hicb = 0xBF; // 1011 1111
    ...
    private static AcceptRange[] AcceptRanges = new AcceptRange[] {
