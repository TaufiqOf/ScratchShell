...
namespace XtermSharp
{
    ...
    {
        private const int MINIMUM_COLS = 2;
        private const int MINIMUM_ROWS = 1;

        //static Dictionary<int, int> matchColorCache = new Dictionary<int, int> ();
        private readonly ITerminalDelegate terminalDelegate;

        private readonly ControlCodes controlCodes;
        private readonly List<string> titleStack;
        private readonly List<string> iconTitleStack;
        private readonly BufferSet buffers;
        private readonly InputHandler input;

        private BufferLine blankLine;

        // modes
        private bool insertMode;

        private bool bracketedPasteMode;

        // saved modes
        private bool savedMarginMode;

        private bool savedOriginMode;
        private bool savedWraparound;
        private bool savedReverseWraparound;

        // unsorted
        private bool applicationKeypad, applicationCursor;

        private bool cursorHidden;
        private Dictionary<byte, string> charset;
        private int gcharset;
        private int gLevel;
        private int refreshStart = Int32.MaxValue;
        private int refreshEnd = -1;
        ...
        /// </summary>
        private void EncodeMouseUtf(List<byte> data, int ch)
        {
            if (ch == 2047)
            {
                data.Add(0);
        ...
        /// </summary>
        private void Report(string prefix, string text, object[] args)
        {
