...
namespace XtermSharp.CommandExtensions
{
    ...
    internal static class TerminalBufferManipulationCommandExtensions
    {
        ...
        /// </summary>
        private static (bool valid, int top, int left, int bottom, int right) GetRectangleFromRequest(Buffer buffer, bool originMode, int start, int[] pars)
        {
        ...
        /// internal coordinates
        /// </summary>
        private static (bool valid, int top, int left, int bottom, int right) GetRectangleFromRequest(Buffer buffer, bool originMode, int top, int left, int bottom, int right)
        {
            if (bottom < 0)
            {
                bottom = buffer.Rows;
