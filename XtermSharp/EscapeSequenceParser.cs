...
namespace XtermSharp
{
    ...
    public class EscapeSequenceParser : IDisposable
    {
        ...
        private static int[] PRINTABLES = r(0x20, 0x7f);
        private static int[] EXECUTABLES = r(0x00, 0x19).Concat(r(0x1c, 0x20)).ToArray();
        ...
        private static ParsingState EmptyErrorHandler(ParsingState state) => state;
        ...
        private unsafe PrintHandler printHandler = (data, start, end) => { };
